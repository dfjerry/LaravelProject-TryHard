...
@section("content")
    <div class="card">
        ...
        <div class="card-header">
            <a href="{{url("admin/new-distributor")}}" class="float-right btn btn-outline-primary">+</a>
        </div>
        <!-- /.card-header -->
            ...
            <table class="table table-hover text-nowrap">
                ...
                @foreach($distributors as $distributor)
                    <tr>
                        ...
                        <td>
                            <a href="{{url("admin/edit-distributor/{$distributor->__get("id")}")}}" class="btn btn-outline-warning">Edit</a>

                        </td>
                        <td> <form action="{{url("admin/delete-distributor/{$distributor->__get("id")}")}}" method="post">
                                @method("DELETE")
                                @csrf
